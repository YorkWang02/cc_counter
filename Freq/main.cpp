...
int main(int argc, char** argv)
{
    ...
    double throughput_insert[3];
    double throughput_query[3];
    double aae[3];
    double are[3];
...
/********************************insert*********************************/
	...
	clock_gettime(CLOCK_MONOTONIC, &time1);
        ...
        throughput_insert[0] = throughput_cccounter;
	//printf("Pcc = %.6lf\n", cccounter->zero());

    clock_gettime(CLOCK_MONOTONIC, &time1);
        for (int t = 0; t < testcycles; t++)
        {
                cccounter2 = new CCCounter2(memory * 1024 *1024/8);
		for (int i = 0; i < package_num; i++)
                {
        ...
        throughput_insert[1] = throughput_cccounter2;
    
    clock_gettime(CLOCK_MONOTONIC, &time1);
        for (int t = 0; t < testcycles; t++)
        {
                cccounter3 = new CCCounter3(memory * 1024 *1024/8);
		for (int i = 0; i < package_num; i++)
                {
        ...
        throughput_insert[2] = throughput_cccounter3;
...
/********************************query*********************************/
    ...
    // sum += res_tmp;   
        ...
        throughput_query[0] = throughput_cccounter;
        //printf("%d\n", res_tmp);
        sum += res_tmp;
    ...
    clock_gettime(CLOCK_MONOTONIC, &time1);
        ...
        throughput_query[1] = throughput_cccounter2;
        //printf("%d\n", res_tmp);
        sum += res_tmp;
        ...
        throughput_query[2] = throughput_cccounter3;
        //printf("%d\n", res_tmp);
        sum += res_tmp;
...
/********************************************************************************************/
    ...
    // 	printf("aae_pcu = %lf\n", ae_pcusketch_sum / b); 
	printf("aae_CC = %lf\n", ae_cccounter_sum / b);
    aae[0] = ae_cccounter_sum / b;
    printf("aae_CC2 = %lf\n", ae_cccounter2_sum / b);
    aae[1] = ae_cccounter2_sum / b;
    printf("aae_CC3 = %lf\n", ae_cccounter3_sum / b);
    aae[2] = ae_cccounter3_sum / b;
    ...
    // 	printf("are_pcu = %lf\n", re_pcusketch_sum / b);
    printf("are_CC = %lf\n", re_cccounter_sum / b);
    are[0] = re_cccounter_sum / b;
    printf("are_CC2 = %lf\n", re_cccounter2_sum / b);
    are[1] = re_cccounter2_sum / b;
    printf("are_CC3 = %lf\n", re_cccounter3_sum / b);
    are[2] = re_cccounter3_sum / b;
    ...
    ofstream outFile("output.csv",std::ios::app);
    outFile << memory << ",CC," << throughput_insert[0] << "," << throughput_query[0] << "," << aae[0] << "," << are[0] << "\n";
    outFile << memory << ",CC2," << throughput_insert[1] << "," << throughput_query[1] << "," << aae[1] << "," << are[1] << "\n";
    outFile << memory << ",CC3," << throughput_insert[2] << "," << throughput_query[2] << "," << aae[2] << "," << are[2] << "\n";
    outFile.close();

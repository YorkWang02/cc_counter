#ifndef _cuckoocounter32_H
#define _cuckoocounter32_H
#include <cmath>
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
using namespace std;
class cuckoocounter32 : public sketch::BaseSketch{
private:
	struct node { int C, FP; string ID; } HK[CC_d][MAX_MEM + 10][BN]; 
	BOBHash64 * bobhash;
	int K, M2;
public:
	cuckoocounter32(int M2, int K) :M2(M2), K(K)
	{ 
